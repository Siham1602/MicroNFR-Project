...
public class EntityChangeInterceptor extends EmptyInterceptor {
    ...
    public boolean onFlushDirty(Object entity, Serializable id, Object[] currentState, Object[] previousState, String[] propertyNames, Type[] types) {
        ...
        System.out.println("----------------test kafka update ------------");
        return false;
    ...
    public boolean onSave(Object entity, Serializable id, Object[] state, String[] propertyNames, Type[] types) {
        if (entity.getClass().isAnnotationPresent(IgnoreAudit.class))
            return false;
    ...
    private Long getEntityId(Object entity) {
        try {
            Field idField = entity.getClass().getDeclaredField("id"+entity.getClass().getSimpleName());
